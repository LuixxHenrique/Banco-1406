...
class Bank:
    ...
    def menu(self):
        ...
        self.m_l1 = Label(self.menu, text='Welcome {}'.format(self.user), bg="#777777", font=('Times', '20', 'bold'),
                          fg="#ffffff")
        self.m_l1.grid(row=0, column=0, padx=60, pady=10)

        self.m_b1 = tk.Button(self.menu, text='DEBIT', bg="#777777", width=10, font=('Times', '20', 'bold'),
                              command=self.debframe, fg="#003b8b")
        self.m_b1.grid(row=1, column=0, padx=60, pady=10)

        self.m_b2 = tk.Button(self.menu, text='CREDIT', width=10, bg="#777777", font=('Times', '20', 'bold'),
                              command=self.credit_Balance, fg="#003b8b")
        self.m_b2.grid(row=2, column=0, padx=76, pady=20)

        self.m_b3 = tk.Button(self.menu, text='Profile', bd=0, bg="#777777", font=('Times', '20', 'bold'),
                              command=self.show_profile, fg="#aadcba")
        self.m_b3.grid(row=0, column=1, padx=76, pady=25)

        self.m_b4 = tk.Button(self.menu, text='LOGOUT', width=10, bg="#777777", font=('Times', '18', 'bold'),
    ...
    def credit_Balance(self):
        ...
        self.up_amnt_lbl1 = Label(self.credframe, text='Welcome {} to Credit Services'.format(self.user), bg="#777777",
                                  font=('Times', '20', 'bold'), fg="#ffffff")
        self.up_amnt_lbl1.grid(row=0, column=0, columnspan=2, pady=10)

        self.up_amnt_lbl2 = Label(self.credframe, text='Enter amount to credit', bg="#777777",
                                  font=('Times', '26', 'bold'), fg="#ffffff")
        self.up_amnt_lbl2.grid(row=1, column=0, columnspan=2, pady=10)

        self.up_amnt_lbl = Label(self.credframe, text='Amount', bg="#777777", font=('Times', '25', 'bold'),
                                 fg="#ffffff")
        ...
        self.up_amnt_btn = tk.Button(self.credframe, text='update balance', bg="#777777", font=('Times', '20', 'bold'),
                                     width=15, command=self.credit, fg="#000000")
        self.up_amnt_btn.grid(row=3, column=1, pady=13, padx=72)

        self.up_amnt_btn1 = tk.Button(self.credframe, text='<<Back', bg="#777777", font=('Times', '18', 'bold'),
    ...
    def debframe(self):
        ...
        self.up_amnt_lbl1 = Label(self.debit_Balance, text='Welcome {} to Debit Services'.format(self.user),
                                  font=('Times', '20', 'bold'), fg="#ffffff", bg='#777777')
        ...
        self.up_amnt_lbl2 = Label(self.debit_Balance, text='Amount', font=('Times', '20', 'bold'), fg="#ffffff",
                                  bg='#777777')
        ...
        self.up_amnt_btn = tk.Button(self.debit_Balance, text='update', bg="#777777", font=('Times', '20', 'bold'),
                                     command=self.update_balance, fg="#000000", width=12)
        self.up_amnt_btn.grid(row=3, column=1, pady=16)

        self.up_amnt_btn1 = tk.Button(self.debit_Balance, text='<<Back', bg="#777777", font=('Times', '18', 'bold'),
    ...
    def show_profile(self):
        ...
        self.p_b1 = tk.Button(self.profframe, text='Change Name', bg="#777777", font=('Times', '20', 'bold'), width=13,
    ...
    def main_frame(self):
        ...
        self.l0 = Label(self.f, text="Welcome To PYTHON Banking Services", bg='#777777', font=('Times', '20', 'bold'),
                        fg='#abcdef')
        ...
        self.e1 = Entry(self.f, textvariable=Bank.username, bg='#123456', width=20, font=('Times', '20', 'bold'),
                        fg='#FFFFFF')
        ...
        self.e2 = Entry(self.f, textvariable=Bank.password, show='*', bg='#123456', width=20,
                        font=('Times', '20', 'bold'), fg='#FFFFFF')
        self.e2.grid(row=2, column=1, padx=20)

        self.b3 = Button(self.f, bg='#777777', text='forget password ?', font=('Times', '12', 'bold'),
                         command=self.fpass, fg='red', width=30, bd=0)
        self.b3.grid(row=3, column=1)

        self.b1 = Button(self.f, bg='#777777', text='LOGIN', font=('Times', '20', 'bold'), command=self.login,
                         fg='#123456')
        self.b1.grid(row=4, column=0, columnspan=4, padx=19, pady=31)

        self.b2 = Button(self.f, bg='#777777', text='SIGNUP', font=('Times', '20', 'bold'), command=self.signup,
                         fg='#123456')
    ...
    def signup(self):
        ...
        self.se1 = Entry(self.sp, textvariable=self.uname, bg='#123456', width=20, font=('Times', '20', 'bold'),
                         fg='#FFFFFF')
        ...
        self.se2 = Entry(self.sp, textvariable=self.creds, show='*', bg='#123456', width=20,
                         font=('Times', '20', 'bold'), fg='#FFFFFF')
        ...
        self.se3 = Entry(self.sp, textvariable=self.bal, bg='#123456', width=20, font=('Times', '20', 'bold'),
                         fg='#FFFFFF')
        self.se3.grid(row=2, column=1)

        self.sb2 = Button(self.sp, bg='#777777', text='SIGNUP', font=('Times', '20', 'bold'), command=self.mksignup,
                          fg='#123456')
        self.sb2.grid(row=3, column=1, columnspan=4)

        self.sb3 = tk.Button(self.sp, text='<<Back', width=10, bg="#777777", font=('Times', '18', 'bold'),
